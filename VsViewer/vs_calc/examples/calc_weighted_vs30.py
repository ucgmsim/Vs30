...
cpts = [vs_calc.CPT(str(cpt_ffp)) for cpt_ffp in cpt_ffps]
...
vs_profiles = [
    vs_calc.VsProfile(cpt, correlation) for cpt in cpts for correlation in correlations
]
vs30, vs30_sd = vs_calc.calculate_weighted_vs30(
