...
vs30_correlation_weights = {"boore_2011": 1.0}

vs_profiles = [
    VsProfile.from_cpt(cpt, cpt_correlation, vs30_correlation) for cpt in cpts for cpt_correlation in cpt_correlations
]
