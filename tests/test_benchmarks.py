...
STANDARD_NZ_GRID = config.GridConfig(
    grid_xmin=1060050,
    grid_xmax=2120050,
    grid_ymin=4730050,
    grid_ymax=6250050,
...
def test_foster_2019_multiprocess():
    ...
    run_benchmark(constants.FixedModelVersion.FOSTER_2019, FOSTER_2019_GRID, n_proc=os.cpu_count() or 1)
...
def test_modified_foster_2019_multiprocess():
    ...
    run_benchmark(constants.FixedModelVersion.MODIFIED_FOSTER_2019, STANDARD_NZ_GRID, n_proc=os.cpu_count() or 1)
...
def test_jaehwi_v1p0_multiprocess():
    ...
    run_benchmark(constants.FixedModelVersion.JAEHWI_V1P0, STANDARD_NZ_GRID, n_proc=os.cpu_count() or 1)
