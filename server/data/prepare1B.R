...
spdf = as(raster(paste0(RASTER_DIR, "aak_mvn_vs30.tif")), "SpatialPointsDataFrame")
spdf_stdv = as(raster(paste0(RASTER_DIR, "aak_mvn_stdev.tif")), "SpatialPointsDataFrame")
