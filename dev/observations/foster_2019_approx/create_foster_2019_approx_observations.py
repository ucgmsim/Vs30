"""
Create the observation CSV for the foster_2019_approx model (approximate
reproduction of Foster et al. 2019).

The original paper excludes ALL Kaiser Q3 stations. This script filters
...
Can be run from the refactored environment:
    ...
    python dev/observations/foster_2019_approx/create_foster_2019_approx_observations.py
...
OUTPUT_CSV = OBSERVATIONS_DIR / "foster_2019_approx_measured_vs30_independent_observations.csv"


def main():
    print("Creating foster_2019_approx observation CSV from modified version")
    print("=" * 70)
    ...
    with open(OUTPUT_CSV, "w") as f:
        f.write("# foster_2019_approx independent observations (approximate reproduction of Foster et al. 2019)\n")
        f.write("# Generated by: dev/observations/foster_2019_approx/create_foster_2019_approx_observations.py\n")
