"""
Create the clean combined observation CSVs for the modified Foster 2019 version of the Vs30 model.
...
def main():
    ...
    output_file_filtered = (
        OUTPUT_DIR / "modified_foster_2019_measured_vs30_independent_observations.csv"
    )
