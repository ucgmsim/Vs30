...
obs_locations = data.frame(x=c(1997000, 2000000, 1998000), y=c(5502000, 5500000, 5501000))
model_locations = data.frame(x=c(1999000, 2000000, 2002000, 2220000), y=c(5500000, 5500000, 5500000, 5500000))
model_variances = c(0.2, 0.1, 0.5, 0.5) ^ 2
variogram = read.csv("../data/variogram_ahdiak_hybrid_v6.csv")[2:10]
class(variogram) = c("variogramModel", "data.frame")
modeledValues = log(c(400, 500, 600, 800))
modelVarObs = c(0.2, 0.1, 0.2) ^ 2
logModVs30obs = log(c(300, 500, 800))
obs_residuals = log(c(50, 1500, 1500)) - logModVs30obs
covReducPar = 1.5
obs_stdev_log = c(0.1, 0.1, 0.1)
numVGpoints = 128
